...
This report reviews and integrates current research efforts in Bangla spell checkers and grammar correctors and in the broader field of Natural Language Processing (NLP). It establishes the research context and identifies the gaps and trends that exist in the state of knowledge that form the foundation of the Byakaron system.
...
This benchmark allows for a structured approach to produce incorrect sentences that could also be applicable for other Indian languages and thus help overcome the lack of annotated data for various low-resource language-related research.
...
Commercially available solutions like REVE NLP offer spell and grammar checks for the Bangla language as part of enterprise offerings. However, these tools are not freely available for research and general use, and therefore, the contribution of these libraries to the open-source ecosystem is limited.
